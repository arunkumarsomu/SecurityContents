...
<html>
<head>
<title>Bozone Bank Account Transfer</title>
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1" />
<link rel="stylesheet" href="theme/a03.css" type="text/css" />
</head>
<body>
<hr/>
<h1>Bozone Bank Account Transfer</h1>
<hr/>
Your accounts are:
<%
...
<p>Please enter the account to transfer to:</p>
<p>Account Identifier <input type="text" name="target" /> </p>

<p>Please enter the amount to transfer:</p>
<p>Amount <input type="text" name="amount" /> </p>

  <input type="Submit" name="Submit" />
  <input type="hidden" name="csrfPrevention" value="${csrfValue}"/>
</form>
<br/>
<hr/>
