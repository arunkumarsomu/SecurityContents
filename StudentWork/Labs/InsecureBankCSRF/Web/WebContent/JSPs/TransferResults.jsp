...
<p>$${amt} was successfully transferred from ${sourceacct.accountNumber} to ${targetacct.accountNumber}</p>
<p>The new balance for account ${sourceacct.accountNumber} is $${sourceacct.balance}</p>  

<p>The new balance for account ${targetacct.accountNumber} is $${targetacct.balance}</p>  
<br/>
<br/><br/><br/><hr/>
<hr/>
